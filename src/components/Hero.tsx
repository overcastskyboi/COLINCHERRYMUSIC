          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10">
            {spotifyLink && (
              <a 
                ...
                className="inline-flex items-center gap-3 bg-white text-black px-8 py-4 rounded-full font-black uppercase text-[11px] tracking-widest hover:scale-105 active:scale-95 transition-all hover:bg-emerald-400 hover:text-black hover:shadow-[0_0_30px_rgba(16,185,129,0.3)] w-full sm:w-auto justify-center"
              >
            ...
            {appleMusicLink && (
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 bg-black/40 border border-white/10 text-white px-8 py-4 rounded-full font-black uppercase text-[11px] tracking-widest hover:scale-105 active:scale-95 transition-all hover:bg-white hover:text-black hover:shadow-[0_0_30px_rgba(255,255,255,0.2)] w-full sm:w-auto justify-center backdrop-blur-md"
              >
                <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
