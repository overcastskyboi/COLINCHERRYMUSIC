...
const Footer = () => {
  const socials = [
    { 
      name: 'Instagram', 
      icon: <Instagram size={24} fill="#E1306C" stroke="#E1306C" />, 
    ...
    { 
      name: 'TikTok', 
      icon: (
        <svg viewBox="0 0 24 24" width="24" height="24" fill="white" style={{ filter: 'drop-shadow(-1px -1px 0 #25F4EE) drop-shadow(1px 1px 0 #FE2C55)' }}>
    ...
    { 
      name: 'Facebook', 
      icon: <Facebook size={24} fill="#1877F2" stroke="#1877F2" />, 
    ...
    { 
      name: 'SoundCloud', 
      icon: (
        <svg viewBox="0 0 24 24" width="24" height="24" fill="#FF5500">
